...
export const ThemeProvider = ({ children }) => {
  ...
  // useColorScheme() can return null on first render on some Android devices.
  // Appearance.getColorScheme() provides the synchronous initial value as fallback.
  const rawDeviceScheme = useColorScheme();
  const deviceColorScheme = rawDeviceScheme ?? Appearance.getColorScheme() ?? "light";
