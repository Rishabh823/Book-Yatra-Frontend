  ...
  return (
    <View style={rs.row}>
      ...
      <Text
        style={[
          rs.rowValue,
          highlight && { color: "#16A34A", fontWeight: "700" },
        ]}
      >
        {value || "—"}
      </Text>
...
export default function VerifyBooking() {
  ...
  const isValid =
    ["confirmed", "paid", "checked_in"].includes(data.status) && isPaid;
    ...
    <SafeAreaView style={s.container} edges={["top"]}>
      ...
      <ScrollView contentContainerStyle={s.scroll}>
        ...
        <View
          style={[
            s.statusCard,
            { borderColor: isValid ? "#16A34A" : "#D97706" },
          ]}
        >
          <View
            style={[
          ...
          <Text
            style={[s.statusTitle, { color: isValid ? "#16A34A" : "#D97706" }]}
          >
        ...
        {data.isCheckedIn && (
          <View style={s.checkedInBanner}>
            ...
            <Text style={s.checkedInText}>
              Checked in
              {data.checkedInAt ? ` on ${fmtDate(data.checkedInAt)}` : ""}
            </Text>
          </View>
        )}
        ...
        <View style={s.card}>
          ...
          {data.seatNumber && (
            <Row label="Seat Number" value={data.seatNumber} />
          )}
        </View>
