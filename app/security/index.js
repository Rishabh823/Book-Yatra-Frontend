...
import { securityApi, auth as authApi } from "../../lib/api";
...
const SCORE_LABEL = (s) =>
  s >= 80 ? "Strong" : s >= 60 ? "Fair" : s >= 40 ? "Weak" : "At Risk";
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <View style={styles.scoreSection}>
          <View style={styles.scoreCard}>
            <View style={[styles.scoreCircle, { borderColor: scoreColor }]}>
              <Text style={[styles.scoreNum, { color: colors.textPrimary }]}>
                {score}
              </Text>
            </View>
                  ...
                  <React.Fragment key={i}>
                    <View style={styles.eventRow}>
                      <View
                        style={[
                          styles.eventDot,
                          { backgroundColor: isBad ? "#FEE2E2" : "#DCFCE7" },
                        ]}
                      >
                        <Ionicons
        ...
        <View style={[styles.section, { marginBottom: 8 }]}>
          ...
          <View style={[styles.menuList, { borderColor: "#FEE2E2" }]}>
            <TouchableOpacity
              style={styles.menuRow}
