            ...
            <View style={sd.stepWrap}>
              ...
              >
                {step > n ? (
                  ...
                  <Text style={[sd.num, step >= n && { color: "#fff" }]}>
                    {n}
                  </Text>
                )}
              </View>
              <Text
                style={[sd.lbl, step >= n && sd.lblActive]}
                numberOfLines={1}
              >
                {STEP_LABELS_REG[i]}
              </Text>
...
export default function Register() {
  ...
  const onCreateAccount = async () => {
    ...
    if (isManager && !businessName.trim()) {
      showToast("Business / organization name is required");
      return;
    }
    ...
    try {
      ...
      setTimeout(() => {
        if (returnTo) {
          ...
          loginRes?.user?.role === "user" &&
          !(loginRes?.user?.joinedOperators?.length > 0)
        ) {
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
        <LinearGradient colors={[colors.secondary, "#1E0504"]} style={s.hero}>
          <View
            style={[
              s.decCircle,
              { width: 200, height: 200, top: -70, right: -60 },
            ]}
          />
          <View
            style={[
        ...
        <View style={s.typeCard__container}>
          <TouchableOpacity
            style={s.typeCard}
            onPress={() => setRegType("user")}
            testID="reg-type-user"
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={s.typeSub}>
                Book tours, track yatras & manage your bookings
              </Text>
            </View>
          ...
          <TouchableOpacity
            style={s.typeCard}
            onPress={() => setRegType("manager")}
            testID="reg-type-manager"
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={s.typeSub}>
                Create & manage tours, handle bookings & team
              </Text>
            </View>
            <View style={s.typeChevron}>
              <Ionicons
      ...
      >
        ...
        >
          ...
          <LinearGradient colors={[colors.secondary, "#1E0504"]} style={s.hero}>
            ...
            <Text style={s.appLabel}>TRIP KART </Text>
            <Text style={s.title}>
              {isManager ? "Tour Manager" : "Create Account"}
            </Text>
            <Text style={s.sub}>
              {step === 1
          ...
          <View style={s.formCard}>
            ...
            <View style={s.badgeRow}>
              <View style={[s.badge, isManager && s.badgeManager]}>
                <Ionicons
                  name={isManager ? "bus-outline" : "person-outline"}
                  size={13}
                  color={isManager ? "#D97706" : colors.primary}
                />
              ...
              {step === 1 && (
                <>
                  ...
                  <Text style={s.stepSub}>
                    We'll send a 6-digit OTP to verify it.
                  </Text>
                  <View style={ss.field}>
                      ...
                      ? [
                          {
                            ...
                            placeholder: "e.g. Jai Shyam Travels",
                            required: true,
                          },
                        ]
                      : []),
                    ...
                    {loading ? (
                      ...
                      <>
                        <Text style={s.ctaText}>
                          {isManager ? "Register as Manager" : "Create Account"}
                        </Text>
